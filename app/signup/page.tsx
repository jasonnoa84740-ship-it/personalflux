        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr]">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 sm:p-10">
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-white/60 sm:text-lg">
              Rejoins PersonaFlux pour créer, gérer et monétiser tes clones IA premium.
            </p>
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.03] p-8 sm:p-10">
            <div className="text-sm text-white/45">Pourquoi créer un compte ?</div>
            <h2 className="mt-2 text-2xl font-semibold">Lance ton espace PersonaFlux</h2>

            <div className="mt-8 space-y-4">
              {[
                "Créer ton premier clone IA",
                "Accéder au dashboard",
                "Gérer ton abonnement premium",
                "Préparer la monétisation de ton produit",
              ].map((item) => (
                <div
                  key={item}
